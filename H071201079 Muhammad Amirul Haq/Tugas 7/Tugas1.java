...
public class Tugas1 {
       ...
       filmFavorite.put("Cast", new ArrayList<>());
        ...
        while(cek.equalsIgnoreCase("Y")) {
            ...
            if(input.equalsIgnoreCase("d")) {
                ...
                int nomorFilm = scanner.nextInt() - 1;
                ...
                int deleteNumberOfFilm = scanner.nextInt() - 1;
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> filmFavorite, Scanner scanner) {

        scanner.nextLine();
        String judul;   String rilis;   String durasi;
        String genre;   String sinopsis;    String cast;

        System.out.println("Judul:"); judul = scanner.nextLine();
        System.out.println("Rilis:"); rilis = scanner.nextLine(); 
        System.out.println("Durasi:"); durasi = scanner.nextLine();
        System.out.println("Genre:"); genre = scanner.nextLine();
        System.out.println("Sinopsis:"); sinopsis = scanner.nextLine();
        System.out.println("Cast:"); cast = scanner.nextLine();
